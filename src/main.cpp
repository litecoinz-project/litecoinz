    ...
    bool fCheckPOW)
{
    ...
    if (fCheckPOW) {
        int oldSize = chainparams.EquihashSolutionWidth(chainparams.GetConsensus().EquihashForkHeight());
        int newSize = chainparams.EquihashSolutionWidth(chainparams.GetConsensus().EquihashForkHeight() - 1);
        ...
        if (!CheckEquihashSolution(&block, chainparams.GetConsensus()))
