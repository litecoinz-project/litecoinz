    ...
    consoleFontSize(0)
{
    ...
    if (platformStyle->getImagesOnButtons()) {
        ui->openDebugLogfileButton->setIcon(platformStyle->MultiColorIcon(":/images/open"));
    }
    ui->clearButton->setIcon(platformStyle->MultiColorIcon(":/images/clear"));
    ui->fontBiggerButton->setIcon(platformStyle->MultiColorIcon(":/images/fontbigger"));
    ui->fontSmallerButton->setIcon(platformStyle->MultiColorIcon(":/images/fontsmaller"));
